...
<head>
  ...
  <link href="css/stylesheets/admin-especialidad.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Especialidades</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $data['idEsp']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificarEspecialidad('<?php echo $data['idEsp']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminarEspecialidad('<?php echo $data['idEsp']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormNuevo" action="server/crearEspecialidad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEsp" id="idEsp-Nuevo" minlength="5" maxlength="5" placeholder="EL000"><br>
            Especialidad<br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormModificar" action="server/modificarEspecialidad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEsp" id="idEsp-Modificar" minlength="5" maxlength="10"><br>
            Especialidad<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminarEspecialidad.php" method="POST">
            <input type="hidden" id="idEsp-Eliminar" name="idEsp" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminarEspecialidad(idEsp) {
      $("#idEsp-Eliminar").val(idEsp);
    }

    function modificarEspecialidad(idEsp, nombre) {
