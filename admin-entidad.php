...
<head>
  ...
  <link href="css/stylesheets/admin-entidad.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Entidades</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="dt-buttons btn-group" id="botoneria">
          ...
          <a class="btn btn-default btn-nuevo" data-toggle="modal" data-target="#ModalNuevo"><span>Nueva Entidad</span></a>
        </div>
      </div>    
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button class='btn btn-info modificar' onclick="modificarEntidad('<?php echo $data['idEntidad']; ?>', '<?php echo $data['nombre']; ?>', '<?php echo $data['titular']; ?>', '<?php echo $data['email']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminarEntidad('<?php echo $data['idEntidad']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormNuevo" action="server/crearEntidad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEntidad" id="idEntidad-Nuevo" minlength="5" maxlength="5" placeholder="EN000"><br>
            Entidad<br>
            <input type="text" name="nombre" id="nombre-Nuevo" minlength="5" maxlength="40"><br>
            Titular<br>
            <input type="text" name="titular" id="titular-Nuevo" minlength="5" maxlength="40"><br>
            Email<br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormModificar" action="server/modificarEntidad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEntidad" id="idEntidad-Modificar" minlength="5" maxlength="5" placeholder="EN000"><br>
            Entidad<br>
            <input type="text" name="nombre" id="nombre-Modificar" minlength="5" maxlength="40"><br>
            Titular<br>
            <input type="text" name="titular" id="titular-Modificar" minlength="5" maxlength="40"><br>
            Email<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminarEntidad.php" method="POST">
            <input type="hidden" id="idEntidad-Eliminar" name="idEntidad" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminarEntidad(idEntidad) {
      $("#idEntidad-Eliminar").val(idEntidad);
    }

    function modificarEntidad(idEntidad, nombre, titular, email) {
      $("#idEntidad-Modificar").val(idEntidad);
      $("#nombre-Modificar").val(nombre);
      $("#titular-Modificar").val(titular);
