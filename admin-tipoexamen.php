...
<head>
  ...
  <link href="css/stylesheets/admin-tipoexamen.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Tipos de Exámenes</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $data['idEx']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificar2Examen('<?php echo $data['idEx']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminar2Examen('<?php echo $data['idEx']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormNuevo" action="server/crear2Examen.php" method="POST">
            Codigo<br>
            <input type="text" name="idEx" id="idEx-Nuevo" minlength="5" maxlength="5" placeholder="TX00"><br>
            Tipo de Examen<br>
  ...
  <div id="ModalModificar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Tipo de Examen</h4>
        </div>
        <div class="modal-body">
          <form id="FormModificar" action="server/modificar2Examen.php" method="POST">
            Codigo<br>
            <input type="text" name="idEx" id="idEx-Modificar" minlength="5" maxlength="5" disabled><br>
            Tipo de Examen<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminar2Examen.php" method="POST">
            <input type="hidden" id="idEx-Eliminar" name="idEx" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminar2Examen(idEx) {
      $("#idEx-Eliminar").val(idEx);
    }

    function modificar2Examen(idEx, nombre) {
