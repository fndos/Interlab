...
<head>
  ...
  <link href="css/stylesheets/admin-trabajo.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Puestos de Trabajo</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="dt-buttons btn-group" id="botoneria">
          ...
          <a class="btn btn-default btn-nuevo" data-toggle="modal" data-target="#ModalNuevo"><span>Nuevo Trabajo</span></a>
        </div>
      </div>    
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $data['idTrabajo']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificarTrabajo('<?php echo $data['idTrabajo']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminarTrabajo('<?php echo $data['idTrabajo']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormNuevo" action="server/crearTrabajo.php" method="POST">
            Codigo<br>
            <input type="text" name="idTrabajo" id="idTrabajo-Nuevo" minlength="5" maxlength="5" placeholder="PT000"><br>
  ...
  <div id="ModalModificar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Puesto de Trabajo</h4>
        </div>
        <div class="modal-body">
          <form id="FormModificar" action="server/modificarTrabajo.php" method="POST">
            Codigo<br>
            <input type="text" name="idTrabajo" id="idTrabajo-Modificar" minlength="5" maxlength="5" readonly><br>
            Puesto de Trabajo<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Eliminar Puesto de Trabajo</h4>
        </div>
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminarTrabajo.php" method="POST">
            <input type="hidden" id="idTrabajo-Eliminar" name="idTrabajo" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminarTrabajo(idTrabajo) {
      $("#idTrabajo-Eliminar").val(idTrabajo);
    }

    function modificarTrabajo(idTrabajo, nombre) {
