...
<head>
  ...
  <link href="css/stylesheets/admin-servicio.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Servicios por Especialidad</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <tbody>
          <?php
            ...
            while ($data = mysqli_fetch_assoc($result)) {
              $idEsp = (string) $data['idEsp'];
              
              $search = "SELECT * FROM especialidad WHERE idEsp='$idEsp'";
          ...
          <tr>
            ...
            <td>
              <button class='btn btn-info modificar' onclick="modificarServicio('<?php echo $data['idServicio']; ?>','<?php echo $data['idEsp']; ?>', '<?php echo $data['nombre']; ?>', '<?php echo $data['costo']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminarServicio('<?php echo $data['idServicio']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormNuevo" action="server/crearServicio.php" method="POST">
            Codigo<br>
            <input type="text" name="idServicio" id="idServicio-Nuevo" minlength="5" maxlength="5" placeholder="SE000"><br>
            Especialidad<br>
            <select name="idEsp" id="idEsp-Nuevo">
              <?php
                include 'dbh.php';
              ...
              ?>
              <option value="<?php echo $data['idEsp']?>"><?php echo $nombre;?></option>
              <?php 
                }
                if (isset($result)) { mysqli_free_result($result); }
                mysqli_close($conn);
            ...
            Costo<br>
            <input type="number" name="costo" id="costo-Nuevo" stpe="any" minlength="1" maxlength="40"><br>
          </form>
        </div>
  ...
  <div id="ModalModificar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormModificar" action="server/modificarServicio.php" method="POST">
            Codigo<br>
            <input type="text" name="idServicio" id="idServicio-Modificar" minlength="5" maxlength="5" readonly><br>
            Especialidad<br>
            <select name="idEsp" id="idEsp-Modificar">
              <?php
                include 'dbh.php';
                $query = "SELECT * FROM especialidad ORDER BY nombre";
                $result = mysqli_query($conn, $query) or die;
            ...
            Costo<br>
            <input type="number" name="costo" id="costo-Modificar" stpe="any" minlength="1" maxlength="40"><br>
          </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminarServicio.php" method="POST">
            <input type="hidden" id="idServicio-Eliminar" name="idServicio" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminarServicio(idServicio) {
      $("#idServicio-Eliminar").val(idServicio);
    }

    function modificarServicio(idServicio, idEsp, nombre, costo) {
      $("#idServicio-Modificar").val(idServicio);
      $("#idEsp-Modificar").val(idEsp);
      $("#nombre-Modificar").val(nombre);
      $("#costo-Modificar").val(costo);
    }
  </script>
</body>
</html>