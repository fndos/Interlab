...
<head>
  ...
  <link href="css/stylesheets/admin-tipomedicamento.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Tipos de Medicamentos</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $data['idMed']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificar2Med('<?php echo $data['idMed']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminar2Med('<?php echo $data['idMed']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Nuevo Tipo de Medicamento</h4>
        </div>
        <div class="modal-body">
          <form id="FormNuevo" action="server/crear2Med.php" method="POST">
            Codigo<br>
            <input type="text" name="idMed" id="idMed-Nuevo" minlength="5" maxlength="5" placeholder="TM000"><br>
  ...
  <div id="ModalModificar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Tipo de Medicamento</h4>
        </div>
        <div class="modal-body">
          <form id="FormModificar" action="server/modificar2Med.php" method="POST">
            Codigo<br>
            <input type="text" name="idMed" id="idMed-Modificar" minlength="5" maxlength="5" readonly><br>
            Tipo de Medicamento<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminar2Med.php" method="POST">
            <input type="hidden" id="idMed-Eliminar" name="idMed" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminar2Med(idMed) {
      $("#idMed-Eliminar").val(idMed);
    }

    function modificar2Med(idMed, nombre) {
