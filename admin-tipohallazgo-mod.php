...
<head>
  ...
  <link href="css/stylesheets/admin-tipohallazgo.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Tipos de Hallazgos</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          <?php
            include 'dbh.php';
            $query = "SELECT * FROM tipohallazgo";
          ...
          <tr>
            <td><?php echo $data['idHall']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificar2Hallazgo('<?php echo $data['idHall']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminar2Hallazgo('<?php echo $data['idHall']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Nuevo Tipo de Hallazgo</h4>
        </div>
        <div class="modal-body">
          <form id="FormNuevo" action="server/crear2Hallazgo.php" method="POST">
            Codigo<br>
            <input type="text" name="idHall" id="idHall-Nuevo" minlength="5" maxlength="5" placeholder="TH000"><br>
            Tipo de Hallazgo<br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormModificar" action="server/modificar2Hallazgo.php" method="POST">
            Codigo<br>
            <input type="text" name="idHall" id="idHall-Modificar" minlength="5" maxlength="5" readonly><br>
            Tipo de Hallazgo<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Eliminar Tipo de Hallazgo</h4>
        </div>
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminar2Hallazgo.php" method="POST">
            <input type="hidden" id="idHall-Eliminar" name="idHall" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminar2Hallazgo(idHall) {
      $("#idHall-Eliminar").val(idHall);
    }

    function modificar2Hallazgo(idHall, nombre) {
