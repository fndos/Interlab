      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse"> 
          <ul class="nav navbar-nav">
            ...
            <li><a href="jefe.php">Demandas de Seguridad</a></li>
          </ul><!--/nav navbar-nav-->
    ...
    <div class="container">
      ...
      <div class="alert alert-success alert-dismissable">
        ...
        <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>
          &nbsp; La demanda de seguridad se ha redirigido exitosamente.
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormAceptar" action="server/jefe-aceptarDemanda.php" method="POST">
  ...
  <div id="ModalRedirigir" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormRedirigir" action="server/jefe-redirigirDemanda.php" method="POST">
            ...
            <input type="hidden" id="estado-Redirigir" name="estado" value="Pendiente">
          </form>
  ...
  <div id="ModalComentar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormComentar" action="server/jefe-comentarDemanda.php" method="POST">
