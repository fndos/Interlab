...
<head>
  ...
  <link href="css/stylesheets/admin-tipoenfermedad.min.css" rel="stylesheet">
  <!--Font Stylesheet-->
...
<body>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row" style="border-style: none none ridge none; border-width: 1.4px; margin-left: 0px; margin-right: 0px;">
          <div class="text-left col-sm-8 col-sm-offset-2">
            <h1 id="super-titulo" style="font-family: Arimo; font-weight: lighter;">Tipos de Enfermedades</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <table id="dt-usuarios" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          <?php
            include 'dbh.php';
            $query = "SELECT * FROM tipoenfermedad";
          ...
          <tr>
            <td><?php echo $data['idEn']; ?></td>
            <td><?php echo $data['nombre']; ?></td>
            <td>
              <button class='btn btn-info modificar' onclick="modificar2Enfermedad('<?php echo $data['idEn']; ?>', '<?php echo $data['nombre']; ?>')" data-toggle='modal' data-target='#ModalModificar'>
                <span class='glyphicon glyphicon-pencil'></span>
              </button>
            </td>
            <td>
              <button class='btn btn-danger eliminar' onclick="eliminar2Enfermedad('<?php echo $data['idEn']; ?>')" data-toggle='modal' data-target='#ModalEliminar'>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Nuevo Tipo de Enfermedad</h4>
        </div>
        <div class="modal-body">
          <form id="FormNuevo" action="server/crear2Enfermedad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEn" id="idEn-Nuevo" minlength="5" maxlength="5" placeholder="TE000"><br>
  ...
  <div id="ModalModificar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Tipo de Hallazgo</h4>
        </div>
        <div class="modal-body">
          <form id="FormModificar" action="server/modificar2Enfermedad.php" method="POST">
            Codigo<br>
            <input type="text" name="idEn" id="idEn-Modificar" minlength="5" maxlength="10"><br>
            Tipo de Enfermedad<br>
  ...
  <div id="ModalEliminar" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="FormEliminar" action="server/eliminar2Enfermedad.php" method="POST">
            <input type="hidden" id="idEn-Eliminar" name="idEn" value="">
          </form>
  ...
  <script type="text/javascript">
    function eliminar2Enfermedad(idEn) {
      $("#idEn-Eliminar").val(idEn);
    }

    function modificar2Enfermedad(idEn, nombre) {
